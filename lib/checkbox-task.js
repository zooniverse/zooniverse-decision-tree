...
(function() {
  var CheckboxTask, DecisionTree, _ref,
  ...
  CheckboxTask = (function(_super) {
    ...
    CheckboxTask.prototype.reset = function(values) {
      var choice, choiceIndex, i, input, value, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2, _results;
      _ref1 = this.el.querySelectorAll('input:checked');
