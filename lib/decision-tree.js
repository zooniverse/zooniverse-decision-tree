...
(function() {
  ...
  DecisionTree = (function() {
    ...
    DecisionTree.prototype.TASK = 'decision-tree:task';
    ...
    DecisionTree.prototype.RESET = 'decision-tree:reset';
    ...
    DecisionTree.prototype.handleChange = function(e) {
      return this._dispatchEvent(this.CHANGE, {
        ...
        value: this.currentTask.getValue()
      });
    };
    ...
    DecisionTree.prototype.loadTask = function(task) {
      ...
      if (typeof task === 'function') {
        ...
        return this._dispatchEvent(this.TASK, this.currentTask);
      } else {
    ...
    DecisionTree.prototype.getValues = function() {
      var task, taskKey, values, _ref, _ref1;
      values = {};
      _ref = this.tasks;
      for (taskKey in _ref) {
        task = _ref[taskKey];
        values[task.key] = (_ref1 = task.getValue()) != null ? _ref1 : null;
      }
      return values;
    };
    ...
    DecisionTree.prototype.reset = function() {
      ...
      return this._dispatchEvent(this.RESET);
    };
