...
(function() {
  ...
  Base = (function() {
    ...
    Base.prototype._dispatchEvent = function(eventName, detail) {
      var e;
  ...
  Task = (function(_super) {
    ...
    Task.prototype.confirm = function() {
      return this._dispatchEvent(this.CONFIRM, this.getValue());
    };
  ...
  DecisionTree = (function(_super) {
    ...
    DecisionTree.prototype.loadTask = function(task, value) {
      ...
      if (typeof task === 'function') {
        ...
        this._dispatchEvent(this.LOAD_TASK, this.currentTask);
